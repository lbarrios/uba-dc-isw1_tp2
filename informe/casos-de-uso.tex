...
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=500px]{images/casos_de_uso.pdf}
  \end{center}
\end{figure}
...
%% \cucourse{
%% 1. El cliente quita los productos que desee y agrega los productos que desee, siempre y cuando estén en stock.
%% 2. Si el pedido está sin confirmar, se registra la modificación, FIN CU. & \\
%% 3. Se cancela el pedido anterior: incluye CU Cancelando Pedido.
%% 4. Se genera un nuevo pedido
%% 3. La reserva de productos se anula, y los mismos se reingresan a stock & \\
%% 3. Si fue pagado, es extendido por CU: Reintegrando dinero & \\
%% 4. FIN CU & \\
%% }
%% \end{casodeuso}
